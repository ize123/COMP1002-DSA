...
public class whereNow
{
        ...
        while(!done)
        {
            ...
            switch(choice)
            {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    journeyDetails(graph);
                    break;
                case 8:
                    break;
                case 9:
                    checkJourney(graph, "314.221.lab", "314.218.lab");
                    break;
                case 10:
                    break;
                case 11:
    ...
    public static void insertEdge(DSAGraph graph)
    {
        ...
        System.out.println("Security (Multiple security levels separated by comma)");
        ...
        System.out.println("Barriers(Multiple barriers separated by comma)");
    ...
    public static void deleteEdge(DSAGraph graph)
    {
        ...
        graph.removeEdge(src, dest, distance);
    }

    public static void journeyDetails(DSAGraph graph)
    {
        Scanner sc = new Scanner(System.in);
        System.out.println("Source:");
        String src = sc.nextLine();
    ...
    public static void checkJourney(DSAGraph graph, String src, String dest)
    {
        graph.BFSSearch(src, dest);
    }
}
